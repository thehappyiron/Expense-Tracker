const metrics = [
    ...
    { value: "$2.5M+", label: "Expenses Tracked", description: "This month" },
    { value: "32%", label: "Avg. Savings", description: "User reported" },
    { value: "150+", label: "Countries", description: "Worldwide" },
]
        ...
        <section className="px-6 py-24 bg-zinc-900/20">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <h2 className="font-display text-3xl md:text-4xl font-bold text-zinc-100 mb-4">Helping people save smarter</h2>
                    <p className="text-zinc-500 max-w-lg mx-auto text-balance">
                        Numbers that speak for themselves. See why thousands choose CoinTrack.
                    </p>
                </div>

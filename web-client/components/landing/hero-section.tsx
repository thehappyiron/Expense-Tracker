        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-20 relative">
            ...
            <div className="relative z-10 text-center max-w-3xl mx-auto">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-900/80 border border-zinc-800 mb-8">
                    ...
                    <span className="text-sm text-zinc-400">AI-Powered Financial Insights & Tracking</span>
                </div>

                {/* Headline */}
                <h1 className="font-display text-5xl md:text-7xl font-bold tracking-tight mb-6">
                    <span className="text-zinc-100 block">Track smarter.</span>
                ...
                <p className="text-lg md:text-xl text-zinc-500 max-w-2xl mx-auto mb-10 leading-relaxed text-balance">
                    The intelligent expense tracker that helps you set budgets, track your spending habits, and gain financial clarity
                    effortlessly.
                </p>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col items-start">
                            ...
                            <p className="text-sm text-zinc-500">
                                Trusted by <span className="text-zinc-300 font-medium">50,000+</span> users
                            </p>
                        </div>
                    </div>
                </div>
